    ...
    <div className='w-full py-16'>
        ...
        <div className='flex 2xl:flex-row xl lg::flex-row md:flex-row flex-col justify-center items-center container mx-8 pt-12'>
            <div className='2x:w-1/2 xl:w-1/2 lg:w-1/2 md:w-full w-full flex flex-col justify-center items-center py-12'>
                <Image src={logo} className="max-h-[81px] 2xl:ml-28 xl:ml-0" height={90} alt='LogoImg'/>
                <Image src={logo} className="max-h-[81px] 2xl:ml-28 xl:ml-0 opacity-60" height={90} alt='LogoImg'/>
            </div>
            ...
            <div className="flex flex-col justify-center items-start pl-20 mb-7">
                <p className='uppercase text-2xl font-normal pb-2'>CUSTOMER SERVICE</p>
            ...
            <div className='w-full 2xl:pl-20 xl:pl-20 lg:pl-20 md:pl-20 pl-1 grid grid-cols-2 gap-5 px-3'>
                <input type='text' placeholder='Name' className='rounded-full bg-gray-100 text-black outline-none px-3 py-3' />
                <input type='email' placeholder='Email' className='rounded-full bg-gray-100 text-black outline-none px-3 py-3' />
                <textarea type='text' placeholder='Message' className='rounded-full bg-gray-100 text-black outline-none px-3 py-3 col-span-2' />
                <button className='rounded-full bg-black text-white font-semibold uppercase tracking-widest px-2 py-2 w-auto'>Submit</button>
            </div>
            </div>
            <div>
        ...
        <div className='pt-16 pb-8'>
            <div className="flex flex-col justify-center items-center">
                <p className='uppercase text-2xl font-normal pb-2'>PRESS & PR INQUIRIES</p>
                <div className='w-16 border-t-2 border-t-gray-800'></div> 
            </div>
            <div className='text-center py-7'>
                <span className='font-bold'>shopkinkifish@gmail.com</span>
            </div>
        </div>

        <div className='pb-8'>
            <div className="flex flex-col justify-center items-center">
                <p className='uppercase text-2xl font-normal pb-2'>CUSTOMER SERVICE MAIL</p>
                <div className='w-16 border-t-2 border-t-gray-800'></div> 
            </div>
            <div className='text-center py-7'>
        ...
        <div className='text-center flex flex-col justify-center items-center'>
            <p className='w-96 mx-auto text-gray-900 font-normal tracking-wider text-center mb-4'>For all customer service inquiries, including returns and exchanges</p>
            <p className='w-96 mx-auto text-gray-900 font-normal tracking-wider text-center'>For all customer service inquiries, including returns and exchanges</p>
        </div>
